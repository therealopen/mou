                ...
                <div class="card mg-b-30">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-header-title tx-13 mb-0">New User Forms</h6>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="form-control-label">Enter Email: <span
                                                        class="tx-danger">*</span></label>
                                        ...
                                        <div class="col-md-4 mg-t--1 mg-md-t-0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="form-control-label"> phone_number: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" type="text" name="phone_number"
                                                    placeholder="Eg 255657193660" required>
                                        ...
                                        <div class="col-md-4 mg-t--1 mg-md-t-0">
                                            <div class="form-group">
                                                <label class="form-control-label">Enter LastName: <span
                                                        class="tx-danger">*</span></label>
