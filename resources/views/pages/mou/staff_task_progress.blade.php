                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="task_report_delivery_value" placeholder="enter value" required 
                                        pattern="\d+" title="Please enter values integer number.">
                                    </div>
                                    <div class="form-group">
...
function validateTaskDeliveryComment(textarea) {
    ...
    const pattern = /^[a-zA-Z0-9\s]*$/;   // for alphanumeric characters

    if (!pattern.test(value)) {
        textarea.setCustomValidity("Please enter text and numbers only!");
    } else {
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" name="task_end_date" placeholder="Task End Date" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-layout-footer text-center">
