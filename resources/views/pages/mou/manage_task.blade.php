                        ...
                        <div class="card mg-b-30">
                           <div class="card-header">
                              <div class="d-flex justify-content-between align-items-center">
                                 <div>
                                    <h6 class="card-header-title tx-13 mb-0">Task Detail</h6>
                                 </div>
                                 <div class="text-right">
                                    <div class="d-flex">
                                        ...
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newUserModal">
                                         <i class="fa fa-plus"></i>User Task
                                     </button>&nbsp
                                            
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newTaskDeliveryModal">
                                         <i class="fa fa-plus"></i>Task Delivery
                                     </button>&nbsp 
                                       
                                        
                                         
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newTaskModal">
                                          <i class="fa fa-plus"></i> New Task's
                                      </button>
                                                      ...
                                                      <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="Task_title"
                                                                ...
                                                                pattern="[A-Za-z\s]{3,}" title="Please enter at least 3 alphabetic, Special characters are not allowed.">

                                                        </div>                
                                                        <div class="form-group">
                                                            <label class="form-control-label">Task Description: <span
                                                                    class="tx-danger">*</span></label>
                                                                    <textarea rows="3" style="width:460px" class="form-control is-valid" name="Task_description"
          placeholder="Task Description" required
          oninput="validateTaskDescription(this)"
          title="Please enter text only (alphabetic characters and spaces)."></textarea>

<script>
function validateTaskDescription(textarea) {
    const value = textarea.value.trim();  //whitespace
    const pattern = /^[A-Za-z\s]*$/;      //characters and spaces

    if (!pattern.test(value)) {
        textarea.setCustomValidity("Please enter text only allowed!");
    } else {
        textarea.setCustomValidity("");
                                                      ...
                                                      <div class="form-layout-footer text-center">
                                                            <button style="margin-left:15px" class="btn btn-primary" style="width: 100px;">Save</button>
                                                        </div>
                                                  </div>
  ...
  <div class="modal fade" id="newUserModal" tabindex="-1" role="dialog" aria-labelledby="newContractModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newContractModalLabel">Assign Task To User</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
               ...
               <div class="">
                    ...
                    <form method="POST" action="{{ route('tasks.assign') }}">
                              ...
                              @csrf
                                  ...
                                  <div class="form-layout">
                                      ...
                                      <div class="row">
                                          <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label">Task: <span
                                                        class="tx-danger">*</span></label>
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <label class="input-group-text"
                                                    ...
                                                    <select class="custom-select" id="inputGroupSelect01" name="task_id">
                                  ...
                                  <!-- form-layout -->
                                  <div class="form-layout-footer text-center">
                                    <button class="btn btn-primary" style="width: 250px;">Assign User</button>
                                </div>
...
<div class="modal fade" id="TaskReportModal" tabindex="-1" role="dialog" aria-labelledby="newContractModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!-- New Task Delivery -->
<div class="modal fade" id="newTaskDeliveryModal" tabindex="-1" role="dialog" aria-labelledby="newContractModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newContractModalLabel">Task Delivery</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
               ...
               <div class="">
                     ...
                     <form class="needs-validation" method="POST" action="{{ route('savedelivery.tasks') }}" enctype="multipart/form-data">
                              @csrf
                                  ...
                                  <div class="form-layout">
                                          ...
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <label class="form-control-label">Task Delivery name: <span
                                                          class="tx-danger">*</span></label>
                                                  <input class="form-control" type="text" name="task_delivery_name"
                                                placeholder="Enter Contract Delivery Name" required 
                                                pattern="[A-Za-z\s]{3,}" title="Please enter at least 3 alphabetic characters. Special characters are not allowed.">

                                              </div>
 
                                              <div class="form-group">
  
                                                 <label class="form-control-label">Task Delivery Value: <span
                                                         class="tx-danger">*</span></label>
                                                 <input class="form-control" type="text" name="task_delivery_value"
                                                     placeholder="Enter Contract Delivery Value" required 
                                                     pattern="\d+" title="Please enter value integer number.">
                                             </div>
                                   ...
                                   <div class="form-layout-footer text-center">
                                    <button class="btn btn-primary" style="width: 250px;">Save Delivery</button>
                                </div>
