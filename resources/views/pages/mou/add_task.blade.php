                ...
                <div class="card mg-b-30">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-header-title tx-13 mb-0">Adding Task</h6>
                            </div>
                                        ...
                                        <div class="col-md-4 mg-t--1 mg-md-t-0">
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label">Task Description: <span
                                                        class="tx-danger">*</span></label>
                                                <textarea rows="8" class="form-control is-valid" name="Task_description" placeholder="Task Description"></textarea>
                                            </div>
