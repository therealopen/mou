                ...
                <div class="card mg-b-30">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-header-title tx-13 mb-0">Contract Forms</h6>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST" action="{{ route('savecontracts') }}">
                            @csrf
                                ...
                                <div class="form-layout form-layout-2">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label">Description: <span
                                                        class="tx-danger">*</span></label>
                                                <textarea rows="5" class="form-control is-valid" name="contract_description" placeholder="Description"></textarea>
                                            </div>
                                        </div>
                                        <!-- col-4 -->
                                        <div class="col-md-4 mg-t--1 mg-md-t-0">
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label">Contract Period: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" type="text" name="contract_period"
                                        ...
                                        <div class="col-md-4 mg-t--1 mg-md-t-0">
                                            <div class="form-group">
                                                <label class="form-control-label">Contract Value: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" type="text" name="contract_value"
                                                    placeholder="Enter Contract Value" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label">Contract Delivery: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" type="text" name="site_delivery"
                                                    placeholder="Enter Contrsct Delivery" required>
                                            </div>
                                            <div class="form-group">
