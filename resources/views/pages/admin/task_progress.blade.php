                        ...
                        <div class="card mg-b-30">
                           <div class="card-header">
                              <div class="d-flex justify-content-between align-items-center">
                                 <div>
                                    <h6 class="card-header-title tx-13 mb-0">Change Progress,Terminate,complete Contract </h6>
                                 </div>
...
<table id="compactTable" class="display compact responsive nowrap">
                            ...
                            <td style="color: #0a8fe8; font-weight: bold;"> <span style="color: rgb(0, 30, 255); font-weight: bold;">
                              {{ $contract->approval_status }} ({{ $contract->status_tpc }})
                                       ...
                                       <td>
                                          <button type="button" class="btn btn-info btn-sm" onclick="openModal('{{ $contract->id}}', 'approved')">Change Contract Progress</button>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalVarying">Change Contract Progress</h5>
...
<script>
   function openModal(contractId,'approved') {
       ...
       $('#contract_status').val(status_tpc); // Add this line to set the contract status
       $('#varyingModal').modal('show');
                     ...
                     <script>
                        ...
                        function saveComment() {
                           ...
                           var contract_status = $('#status_tpc').val();;
                            var status_tpc = $('#status_tpc').val();// Fix typo: 'approved' instead of 'aprroved'
